...
:::info Шаблон
Этот файл является шаблоном. Вставьте диаграмму в отмеченное место и дополните описание.
:::
...
| QA-инженер | Просматривает историю версий без права изменения | UC-005 |

## Описание Use Cases {#use-cases}

Детальные спецификации каждого Use Case описаны в разделе [Функциональные требования](../2-requirements/functional-requirements).
